...
| **Vídeo / GIF** | Upload **convertido no próprio navegador** (ffmpeg.wasm): **vídeo** (mp4/webm/mkv/avi) → MPEG‑1 320×240; **GIF** → **`.gif` 320×240 (4:3), 15 fps, ≤ 10 s, abaixo de 15 MB**. Em ambos, o tamanho gerado é **validado contra a memória livre** antes do envio. Galeria com **miniatura (1º quadro) + apelido**; remoção; liga/desliga o app de vídeo. |
